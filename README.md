...
Arcade - FBA (0.2.97.44) | FinalBurnAlpha | [2019-12-24-launcher](https://cdn.discordapp.com/attachments/625718299493138442/659044426907123762/fba-sdl-fixed.opk) | [Active](https://github.com/soarqin/fba-sdl) | Varies, use `FBA UX` to set ROM paths using app interface.
...
Nintendo Game Boy Advance | ReGBA | [Latest](https://github.com/SeongGino/RetroGame350-AppRepo/raw/master/Emulators/ReGBA_2019-12-26.opk) | [Active Fork](https://github.com/soarqin/ReGBA) | (Optional) Game Boy Advance BIOS, `~/.gpsp/gba_bios.bin`
