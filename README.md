...
Commodore 64(DTV), 128, PET, VIC-20, Plus-4 | VICE (Launcher Mod)** | [2019-12-11](https://github.com/SeongGino/RetroGame350-AppRepo/blob/master/Emulators/VICEstandalone_2019-12-xx.zip) | [Inactive Fork](https://github.com/SeongGino/notexistingyet) | VICE Data Folder, extract `VICE` folder to `/usr/local/share/` so that `x64` is in `/usr/local/share/VICE/x64`
